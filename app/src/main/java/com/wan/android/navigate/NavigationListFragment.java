...
public class NavigationListFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        mView = inflater.inflate(R.layout.navigation_list_fragment, container, false);
        return mView;
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        tagFlowLayout.setAdapter(new TagAdapter<ArticleDatas>(mData) {
            ...
            public View getView(FlowLayout parent, int position, ArticleDatas d) {
                TextView textView = (TextView) LayoutInflater.from(mActivity).inflate(R.layout.flowlayout_item, tagFlowLayout, false);
